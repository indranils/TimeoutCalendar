...
#define p7	pc[6] == state_active
#define p8	pc[7] == state_active
#define p9	pc[8] == state_active
#define p10	pc[9] == state_active
#define p11	pc[10] == state_active
#define p12	pc[11] == state_active
#define p13	pc[12] == state_active
#define p14	pc[13] == state_active
#define p15	pc[14] == state_active
#define p16	pc[15] == state_active
#define p17	pc[16] == state_active
#define p18	pc[17] == state_active
#define p19	pc[18] == state_active
#define p20	pc[19] == state_active
#define p21	pc[20] == state_active
#define p22	pc[21] == state_active
#define p23	pc[22] == state_active
#define p24	pc[23] == state_active
#define p25	pc[24] == state_active

#define pp (p1 && p2 && p3 && p4 && p5 && p6 && p7 && p8 && p9 && p10 && p11 && p12 && p13 && p14 && p15 && p16 && p17 && p18 && p19 && p20 && p21 && p22 && p23 && p24 && p25)
