...
#define pp (p1 && p2 && p3 && p4 && p5 && p6 && p7)
#define qq (q1 && q2 && q3 && q4 && q5 && q6 && q7)

#define r (time_out[0] == time_out[1] == time_out[2] == time_out[3] == time_out[4] == time_out[5] == time_out[6])  
#define s (slot[0] == slot[1] == slot[2] == slot[3] == slot[4] == slot[5] == slot[6]) 
