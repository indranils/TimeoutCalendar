...
#define q7	time_out[6] > 0
#define q8	time_out[7] > 0
#define q9	time_out[8] > 0
#define q10	time_out[9] > 0

#define pp (p1 && p2 && p3 && p4 && p5 && p6 && p7 && p8 && p9 && p10)
#define qq (q1 && q2 && q3 && q4 && q5 && q6 && q7 && q8 && q9 && q10)

#define r (time_out[0] == time_out[1] == time_out[2] == time_out[3] == time_out[4] == time_out[5] == time_out[6] == time_out[7] == time_out[8] == time_out[9] == time_out[10])  
#define s (slot[0] == slot[1] == slot[2] == slot[3] == slot[4] == slot[5] == slot[6] == slot[7] == slot[8] == slot[9] == slot[10]) 
