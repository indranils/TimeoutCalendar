...
{	Trans *T;
	...
	trans[3][1]	= settr(425,0,10,3,0,"(!((((((pc[0]==state_active)&&(pc[1]==state_active))&&(pc[2]==state_active))&&(pc[3]==state_active))&&(pc[4]==state_active))))", 1, 2, 0);
	trans[3][2]	= settr(426,0,10,1,0,"goto accept_S9", 0, 2, 0);
	...
	trans[3][8]	= settr(432,0,5,1,0,"(1)", 0, 2, 0);
	trans[3][9]	= settr(433,0,5,1,0,"goto T0_init", 0, 2, 0);
	trans[3][12]	= settr(436,0,13,1,0,"break", 0, 2, 0);
	trans[3][13]	= settr(437,0,0,4,4,"-end-", 0, 3500, 0);
	...
	trans[2][1]	= settr(402,2,20,5,5,"((i==5))", 1, 2, 0);
	trans[2][2]	= settr(403,2,20,1,0,"goto :b19", 1, 2, 0);
	trans[2][3]	= settr(404,2,14,6,6,"((i<5))", 1, 2, 0); /* m: 4 -> 14,0 */
	reached2[4] = 1;
	...
	trans[2][5]	= settr(406,2,11,7,7,"random_timeout = 1", 1, 2, 0);
	...
	trans[2][6]	= settr(407,2,11,8,8,"(((random_timeout>=1)&&(random_timeout<((5+1)-1))))", 1, 2, 0); /* m: 7 -> 11,0 */
	reached2[7] = 1;
	trans[2][7]	= settr(0,0,0,0,0,"random_timeout = (random_timeout+1)",0,0,0);
	trans[2][8]	= settr(409,2,16,9,9,"((random_timeout==((5+1)-1)))", 1, 2, 0); /* m: 15 -> 16,0 */
	reached2[15] = 1;
	trans[2][9]	= settr(410,2,15,1,0,"goto :b20", 1, 2, 0); /* m: 15 -> 0,16 */
	reached2[15] = 1;
	trans[2][10]	= settr(411,2,16,10,10,"goto :b20", 1, 2, 0); /* m: 15 -> 0,16 */
	reached2[15] = 1;
	trans[2][13]	= settr(414,2,15,1,0,"break", 1, 2, 0);
	trans[2][15]	= settr(416,2,16,11,11,"time_out[i] = random_timeout", 1, 2, 0);
	trans[2][16]	= settr(417,2,17,12,12,"(run node(i))", 1, 2, 0);
	trans[2][17]	= settr(418,2,18,13,13,"i = (i+1)", 1, 2, 0);
	trans[2][20]	= settr(421,2,21,1,0,"break", 1, 2, 0);
	trans[2][21]	= settr(422,0,23,14,14,"(run time_advance())", 1, 2, 0);
	trans[2][23]	= settr(424,0,0,15,15,"-end-", 0, 3500, 0);
	...
	trans[1][1]	= settr(155,0,15,16,0,"((pc[i]==state_init))", 1, 2, 0);
	...
	trans[1][2]	= settr(156,2,7,17,17,"(((cal.flag[i]==0)&&(time_out[i]==0)))", 1, 2, 0); /* m: 3 -> 7,0 */
	reached1[3] = 1;
	...
	trans[1][4]	= settr(158,0,244,18,18,"tau_startup = (3*i)", 1, 2, 0); /* m: 6 -> 0,244 */
	reached1[6] = 1;
	trans[1][6]	= settr(0,0,0,0,0,"tau_listen = ((2*round_time)+tau_startup)",0,0,0);
	trans[1][8]	= settr(0,0,0,0,0,"time_out[i] = tau_listen",0,0,0);
	trans[1][14]	= settr(168,0,244,19,19,".(goto)", 1, 2, 0);
	trans[1][9]	= settr(163,2,11,20,0,"((cal.flag[i]&&(cal.delivery==0)))", 1, 2, 0);
	T = trans[ 1][11] = settr(165,0,0,0,0,"sub-sequence", 1, 2, 0);
	T->nxt	= settr(165,0,10,0,0,"sub-sequence", 1, 2, 0);
	trans[1][10]	= settr(164,0,244,21,21,"cal.flag[i] = 0", 1, 2, 0); /* m: 12 -> 0,244 */
	reached1[12] = 1;
	trans[1][12]	= settr(0,0,0,0,0,"event_pending = 0",0,0,0);
	trans[1][16]	= settr(170,0,94,22,0,"((pc[i]==state_listen))", 1, 2, 0);
	...
	trans[1][17]	= settr(171,2,22,23,23,"((!((cal.flag[i]&&(cal.delivery==0)))&&(time_out[i]==0)))", 1, 2, 0); /* m: 18 -> 22,0 */
	reached1[18] = 1;
	...
	trans[1][19]	= settr(173,2,74,24,24,"tau_startup = (3*i)", 1, 2, 0); /* m: 21 -> 0,74 */
	reached1[21] = 1;
	...
	trans[1][24]	= settr(178,2,73,25,25,"j = 0", 1, 2, 0);
	...
	trans[1][25]	= settr(179,2,38,26,26,"i5 = 0", 1, 2, 0); /* m: 26 -> 0,38 */
	reached1[26] = 1;
	...
	trans[1][35]	= settr(189,2,38,30,30,"i5 = (i5+1)", 1, 2, 0);
	...
	trans[1][42]	= settr(196,2,59,31,31,"((empty_cal==1))", 1, 2, 0); /* m: 43 -> 59,0 */
	reached1[43] = 1;
	...
	trans[1][48]	= settr(202,0,244,32,32,"((j==5))", 1, 2, 0); /* m: 72 -> 244,0 */
	reached1[72] = 1;
	...
	trans[1][51]	= settr(205,2,59,33,33,"((j!=i))", 1, 2, 0); /* m: 52 -> 59,0 */
	reached1[52] = 1;
	...
	trans[1][55]	= settr(209,2,59,34,34,"cal.flag[j] = 0", 1, 2, 0); /* m: 56 -> 0,59 */
	reached1[56] = 1;
	trans[1][56]	= settr(0,0,0,0,0,"j = (j+1)",0,0,0);
	trans[1][61]	= settr(215,2,72,1,0,"break", 1, 2, 0);
	trans[1][72]	= settr(226,0,244,35,35,".(goto)", 1, 2, 0); /* m: 93 -> 0,244 */
	reached1[93] = 1;
	...
	trans[1][63]	= settr(217,0,244,36,36,"((j==5))", 1, 2, 0); /* m: 72 -> 244,0 */
	reached1[72] = 1;
	trans[1][64]	= settr(218,2,72,1,0,"goto :b12", 1, 2, 0); /* m: 72 -> 0,244 */
	reached1[72] = 1;
	trans[1][65]	= settr(219,2,66,2,0,"else", 1, 2, 0);
	trans[1][66]	= settr(220,2,68,37,37,"cal.flag[j] = 0", 1, 2, 0); /* m: 67 -> 0,68 */
	reached1[67] = 1;
	trans[1][67]	= settr(0,0,0,0,0,"j = (j+1)",0,0,0);
	trans[1][70]	= settr(224,2,72,1,0,"break", 1, 2, 0);
	trans[1][93]	= settr(247,0,244,38,38,".(goto)", 1, 2, 0);
	trans[1][75]	= settr(229,2,80,39,39,"((((cal.flag[i]==1)&&(cal.msg==cs_frame))&&(cal.delivery==0)))", 1, 2, 0); /* m: 76 -> 80,0 */
	reached1[76] = 1;
	...
	trans[1][77]	= settr(231,2,83,40,40,"tau_startup = (3*i)", 1, 2, 0); /* m: 79 -> 0,83 */
	reached1[79] = 1;
	...
	trans[1][82]	= settr(236,0,244,41,41,"cal.flag[i] = 0", 1, 2, 0); /* m: 93 -> 0,244 */
	reached1[93] = 1;
	trans[1][84]	= settr(238,2,88,42,42,"(((cal.flag[i]&&(cal.msg==i_frame))&&(cal.delivery==0)))", 1, 2, 0); /* m: 85 -> 88,0 */
	reached1[85] = 1;
	...
	trans[1][87]	= settr(241,2,91,43,43,"frame_origin = cal.origin", 1, 2, 0); /* m: 89 -> 0,91 */
	reached1[89] = 1;
	...
	trans[1][90]	= settr(244,0,244,44,44,"cal.flag[i] = 0", 1, 2, 0); /* m: 93 -> 0,244 */
	reached1[93] = 1;
	trans[1][95]	= settr(249,0,171,45,0,"((pc[i]==state_coldstart))", 1, 2, 0);
	...
	trans[1][96]	= settr(250,2,100,46,0,"((!((cal.flag[i]&&(cal.delivery==0)))&&(time_out[i]==0)))", 1, 2, 0);
	...
	trans[1][97]	= settr(251,2,152,47,47,"tau_startup = (3*i)", 1, 2, 0); /* m: 99 -> 0,152 */
	reached1[99] = 1;
	...
	trans[1][102]	= settr(256,2,151,48,48,"j = 0", 1, 2, 0);
	...
	trans[1][103]	= settr(257,2,116,49,49,"i5 = 0", 1, 2, 0); /* m: 104 -> 0,116 */
	reached1[104] = 1;
	...
	trans[1][113]	= settr(267,2,116,53,53,"i5 = (i5+1)", 1, 2, 0);
	...
	trans[1][120]	= settr(274,2,137,54,54,"((empty_cal==1))", 1, 2, 0); /* m: 121 -> 137,0 */
	reached1[121] = 1;
	...
	trans[1][126]	= settr(280,0,244,55,55,"((j==5))", 1, 2, 0); /* m: 150 -> 244,0 */
	reached1[150] = 1;
	...
	trans[1][129]	= settr(283,2,137,56,56,"((j!=i))", 1, 2, 0); /* m: 130 -> 137,0 */
	reached1[130] = 1;
	...
	trans[1][133]	= settr(287,2,137,57,57,"cal.flag[j] = 0", 1, 2, 0); /* m: 134 -> 0,137 */
	reached1[134] = 1;
	trans[1][134]	= settr(0,0,0,0,0,"j = (j+1)",0,0,0);
	trans[1][139]	= settr(293,2,150,1,0,"break", 1, 2, 0);
	trans[1][150]	= settr(304,0,244,58,58,".(goto)", 1, 2, 0); /* m: 170 -> 0,244 */
	reached1[170] = 1;
	...
	trans[1][141]	= settr(295,0,244,59,59,"((j==5))", 1, 2, 0); /* m: 150 -> 244,0 */
	reached1[150] = 1;
	trans[1][142]	= settr(296,2,150,1,0,"goto :b15", 1, 2, 0); /* m: 150 -> 0,244 */
	reached1[150] = 1;
	trans[1][143]	= settr(297,2,144,2,0,"else", 1, 2, 0);
	trans[1][144]	= settr(298,2,146,60,60,"cal.flag[j] = 0", 1, 2, 0); /* m: 145 -> 0,146 */
	reached1[145] = 1;
	trans[1][145]	= settr(0,0,0,0,0,"j = (j+1)",0,0,0);
	trans[1][148]	= settr(302,2,150,1,0,"break", 1, 2, 0);
	trans[1][170]	= settr(324,0,244,61,61,".(goto)", 1, 2, 0);
	trans[1][153]	= settr(307,2,157,62,62,"(((cal.flag[i]&&(cal.msg==cs_frame))&&(cal.delivery==0)))", 1, 2, 0); /* m: 154 -> 157,0 */
	reached1[154] = 1;
	...
	trans[1][156]	= settr(310,2,160,63,63,"frame_origin = cal.origin", 1, 2, 0); /* m: 158 -> 0,160 */
	reached1[158] = 1;
	...
	trans[1][159]	= settr(313,0,244,64,64,"cal.flag[i] = 0", 1, 2, 0); /* m: 170 -> 0,244 */
	reached1[170] = 1;
	trans[1][161]	= settr(315,2,165,65,65,"(((cal.flag[i]&&(cal.msg==i_frame))&&(cal.delivery==0)))", 1, 2, 0); /* m: 162 -> 165,0 */
	reached1[162] = 1;
	...
	trans[1][164]	= settr(318,2,168,66,66,"frame_origin = cal.origin", 1, 2, 0); /* m: 166 -> 0,168 */
	reached1[166] = 1;
	...
	trans[1][167]	= settr(321,0,244,67,67,"cal.flag[i] = 0", 1, 2, 0); /* m: 170 -> 0,244 */
	reached1[170] = 1;
	trans[1][172]	= settr(326,0,243,68,0,"((pc[i]==state_active))", 1, 2, 0);
	...
	trans[1][173]	= settr(327,2,180,69,0,"((time_out[i]==0))", 1, 2, 0);
	...
	trans[1][174]	= settr(328,2,236,70,70,"((slot[i]==(5-1)))", 1, 2, 0); /* m: 175 -> 236,0 */
	reached1[175] = 1;
	...
	trans[1][177]	= settr(331,2,236,71,71,"increment = (slot[i]+1)", 1, 2, 0); /* m: 181 -> 0,236 */
	reached1[181] = 1;
	trans[1][181]	= settr(335,2,236,72,72,"slot[i] = increment", 1, 2, 0); /* m: 182 -> 0,236 */
	reached1[182] = 1;
	...
	trans[1][185]	= settr(339,2,198,75,75,"i5 = 0", 1, 2, 0); /* m: 186 -> 0,198 */
	reached1[186] = 1;
	...
	trans[1][195]	= settr(349,2,198,79,79,"i5 = (i5+1)", 1, 2, 0);
	...
	trans[1][202]	= settr(356,2,219,80,80,"((empty_cal==1))", 1, 2, 0); /* m: 203 -> 219,0 */
	reached1[203] = 1;
	...
	trans[1][208]	= settr(362,0,244,81,81,"((j==5))", 1, 2, 0); /* m: 237 -> 244,0 */
	reached1[237] = 1;
	...
	trans[1][211]	= settr(365,2,219,82,82,"((j!=i))", 1, 2, 0); /* m: 212 -> 219,0 */
	reached1[212] = 1;
	...
	trans[1][215]	= settr(369,2,219,83,83,"cal.flag[j] = 0", 1, 2, 0); /* m: 216 -> 0,219 */
	reached1[216] = 1;
	...
	trans[1][223]	= settr(377,0,244,84,84,"((j==5))", 1, 2, 0); /* m: 237 -> 244,0 */
	reached1[237] = 1;
	trans[1][224]	= settr(378,2,237,1,0,"goto :b18", 1, 2, 0); /* m: 237 -> 0,244 */
	reached1[237] = 1;
	trans[1][225]	= settr(379,2,226,2,0,"else", 1, 2, 0);
	trans[1][226]	= settr(380,2,228,85,85,"cal.flag[j] = 0", 1, 2, 0); /* m: 227 -> 0,228 */
	reached1[227] = 1;
	trans[1][227]	= settr(0,0,0,0,0,"j = (j+1)",0,0,0);
	trans[1][230]	= settr(384,2,237,1,0,"break", 1, 2, 0);
	trans[1][237]	= settr(391,0,244,86,86,".(goto)", 1, 2, 0); /* m: 242 -> 0,244 */
	reached1[242] = 1;
	trans[1][235]	= settr(389,2,237,2,0,"else", 1, 2, 0);
	trans[1][242]	= settr(396,0,244,87,87,".(goto)", 1, 2, 0);
	trans[1][238]	= settr(392,2,240,88,0,"((cal.flag[i]&&((cal.msg==cs_frame)||(cal.msg==i_frame))))", 1, 2, 0);
	T = trans[ 1][240] = settr(394,0,0,0,0,"sub-sequence", 1, 2, 0);
	T->nxt	= settr(394,0,239,0,0,"sub-sequence", 1, 2, 0);
	trans[1][239]	= settr(393,0,244,89,89,"cal.flag[i] = 0", 1, 2, 0); /* m: 242 -> 0,244 */
	reached1[242] = 1;
	trans[1][246]	= settr(400,0,247,1,0,"break", 0, 2, 0);
	trans[1][247]	= settr(401,0,0,90,90,"-end-", 0, 3500, 0);
	...
	trans[0][1]	= settr(0,0,72,91,0,"(timeout)", 1, 3000, 0);
	...
	trans[0][2]	= settr(1,2,15,92,92,"i5 = 0", 1, 2, 0); /* m: 3 -> 0,15 */
	reached0[3] = 1;
	...
	trans[0][12]	= settr(11,2,15,96,96,"i5 = (i5+1)", 1, 2, 0);
	...
	trans[0][19]	= settr(18,2,36,97,0,"(empty_cal)", 1, 2, 0);
	T = trans[ 0][36] = settr(35,0,0,0,0,"sub-sequence", 1, 2, 0);
	T->nxt	= settr(35,0,20,0,0,"sub-sequence", 1, 2, 0);
	trans[0][20]	= settr(19,2,33,98,98,"i1 = 0", 1, 2, 0); /* m: 21 -> 0,33 */
	reached0[21] = 1;
	...
	trans[0][23]	= settr(22,2,41,99,99,"((i1==5))", 1, 2, 0);
	...
	trans[0][26]	= settr(25,2,33,100,100,"((min_timeout>time_out[i1]))", 1, 2, 0); /* m: 27 -> 33,0 */
	reached0[27] = 1;
	...
	trans[0][30]	= settr(29,2,33,101,101,"i1 = (i1+1)", 1, 2, 0);
	...
	trans[0][37]	= settr(36,4,150,102,102,"((min_timeout>0))", 1, 2, 0); /* m: 38 -> 150,0 */
	reached0[38] = 1;
	trans[0][38]	= settr(0,0,0,0,0,"time_can_advance = 1",0,0,0);
	trans[0][42]	= settr(41,4,150,103,103,".(goto)", 1, 2, 0); /* m: 70 -> 0,150 */
	reached0[70] = 1;
	trans[0][39]	= settr(38,2,40,2,0,"else", 1, 2, 0);
	trans[0][40]	= settr(39,4,150,104,104,"time_can_advance = 0", 1, 2, 0); /* m: 42 -> 0,150 */
	reached0[42] = 1;
	trans[0][70]	= settr(69,0,150,105,105,".(goto)", 1, 2, 0);
	...
	trans[0][44]	= settr(43,2,57,106,106,"i1 = 0", 1, 2, 0); /* m: 45 -> 0,57 */
	reached0[45] = 1;
	...
	trans[0][47]	= settr(46,2,62,107,107,"((i1==5))", 1, 2, 0);
	...
	trans[0][50]	= settr(49,2,57,108,108,"((min_timeout>time_out[i1]))", 1, 2, 0); /* m: 51 -> 57,0 */
	reached0[51] = 1;
	...
	trans[0][54]	= settr(53,2,57,109,109,"i1 = (i1+1)", 1, 2, 0);
	...
	trans[0][61]	= settr(60,2,67,110,110,"first_event = cal.delivery", 1, 2, 0);
	T = trans[0][67] = settr(66,2,0,0,0,"IF", 1, 2, 0);
	T = T->nxt	= settr(66,2,63,0,0,"IF", 1, 2, 0);
	    T->nxt	= settr(66,2,65,0,0,"IF", 1, 2, 0);
	trans[0][63]	= settr(62,4,150,111,111,"((((min_timeout>0)&&(first_event>0))&&(first_event!=10000)))", 1, 2, 0); /* m: 64 -> 150,0 */
	reached0[64] = 1;
	trans[0][64]	= settr(0,0,0,0,0,"time_can_advance = 1",0,0,0);
	trans[0][68]	= settr(67,4,150,112,112,".(goto)", 1, 2, 0); /* m: 70 -> 0,150 */
	reached0[70] = 1;
	trans[0][65]	= settr(64,4,150,113,113,"(((min_timeout==0)||(first_event==0)))", 1, 2, 0); /* m: 66 -> 150,0 */
	reached0[66] = 1;
	...
	trans[0][73]	= settr(72,0,148,114,0,"(time_can_advance)", 1, 2, 0);
	...
	trans[0][74]	= settr(73,2,87,115,115,"i5 = 0", 1, 2, 0); /* m: 75 -> 0,87 */
	reached0[75] = 1;
	...
	trans[0][84]	= settr(83,2,87,119,119,"i5 = (i5+1)", 1, 2, 0);
	...
	trans[0][91]	= settr(90,2,104,120,120,"i1 = 0", 1, 2, 0); /* m: 92 -> 0,104 */
	reached0[92] = 1;
	...
	trans[0][94]	= settr(93,2,146,121,121,"((i1==5))", 1, 2, 0);
	...
	trans[0][97]	= settr(96,2,104,122,122,"((min_timeout>time_out[i1]))", 1, 2, 0); /* m: 98 -> 104,0 */
	reached0[98] = 1;
	...
	trans[0][101]	= settr(100,2,104,123,123,"i1 = (i1+1)", 1, 2, 0);
	...
	trans[0][108]	= settr(107,2,115,124,124,"(empty_cal)", 1, 2, 0); /* m: 109 -> 115,0 */
	reached0[109] = 1;
	...
	trans[0][110]	= settr(109,2,115,125,125,"((count<5))", 1, 2, 0); /* m: 111 -> 115,0 */
	reached0[111] = 1;
	...
	trans[0][113]	= settr(112,2,117,126,126,"((count==5))", 1, 2, 0);
	trans[0][114]	= settr(113,2,117,1,0,"goto :b6", 1, 2, 0);
	trans[0][117]	= settr(116,2,147,1,0,"break", 1, 2, 0);
	trans[0][147]	= settr(146,0,152,127,127,".(goto)", 1, 2, 0);
	...
	trans[0][119]	= settr(118,2,144,128,128,"first_event = cal.delivery", 1, 2, 0);
	T = trans[0][144] = settr(143,2,0,0,0,"IF", 1, 2, 0);
	T = T->nxt	= settr(143,2,121,0,0,"IF", 1, 2, 0);
	    T->nxt	= settr(143,2,133,0,0,"IF", 1, 2, 0);
	trans[0][121]	= settr(120,2,128,129,129,"((first_event<=min_timeout))", 1, 2, 0); /* m: 122 -> 128,0 */
	reached0[122] = 1;
	...
	trans[0][123]	= settr(122,2,128,130,130,"((count<5))", 1, 2, 0); /* m: 124 -> 128,0 */
	reached0[124] = 1;
	...
	trans[0][126]	= settr(125,0,152,131,131,"((count==5))", 1, 2, 0); /* m: 131 -> 152,0 */
	reached0[131] = 1;
	trans[0][127]	= settr(126,2,131,1,0,"goto :b7", 1, 2, 0); /* m: 131 -> 0,152 */
	reached0[131] = 1;
	trans[0][130]	= settr(129,2,131,1,0,"break", 1, 2, 0);
	trans[0][131]	= settr(130,0,152,132,132,"cal.delivery = 0", 1, 2, 0); /* m: 132 -> 0,152 */
	reached0[132] = 1;
	trans[0][132]	= settr(0,0,0,0,0,"event_time = 0",0,0,0);
	trans[0][145]	= settr(144,0,152,133,133,".(goto)", 1, 2, 0); /* m: 147 -> 0,152 */
	reached0[147] = 1;
	trans[0][133]	= settr(132,2,134,2,0,"else", 1, 2, 0);
	trans[0][134]	= settr(133,2,140,134,134,"count = 0", 1, 2, 0);
	...
	trans[0][135]	= settr(134,2,140,135,135,"((count<5))", 1, 2, 0); /* m: 136 -> 140,0 */
	reached0[136] = 1;
	...
	trans[0][138]	= settr(137,0,152,136,136,"((count==5))", 1, 2, 0); /* m: 143 -> 152,0 */
	reached0[143] = 1;
	trans[0][139]	= settr(138,2,143,1,0,"goto :b8", 1, 2, 0); /* m: 143 -> 0,152 */
	reached0[143] = 1;
	trans[0][142]	= settr(141,2,143,1,0,"break", 1, 2, 0);
	trans[0][143]	= settr(142,0,152,137,137,"cal.delivery = (cal.delivery-min_timeout)", 1, 2, 0); /* m: 145 -> 0,152 */
	reached0[145] = 1;
	...
	trans[0][155]	= settr(154,0,0,138,138,"-end-", 0, 3500, 0);
	/* np_ demon: */
