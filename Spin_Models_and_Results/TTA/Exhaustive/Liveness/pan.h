...
#define PanSource	"TTAStartup_5Nodes.pml"
...
#define nstates3	14	/* ltl_liveness */
#define minseq3	425
#define maxseq3	437
#define endstate3	13

#define nstates2	24	/* :init: */
#define minseq2	402
#define maxseq2	424
#define endstate2	23

#define nstates1	248	/* node */
#define minseq1	155
#define maxseq1	401
#define endstate1	247

#define nstates0	156	/* time_advance */
#define minseq0	0
#define maxseq0	154
#define endstate0	155
...
struct calender { /* user defined type */
	uchar flag[5];
	uchar msg;
	uchar origin;
	uchar send;
...
typedef struct P3 { /* ltl_liveness */
...
#define Pnode	((P1 *)this)
typedef struct P1 { /* node */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
	...
	uchar _4_4_8_7_1_i5;
	uchar _4_5_14_j;
	uchar _4_5_14_10_2_i5;
	uchar _4_6_20_j;
	uchar _4_6_20_11_3_i5;
	int i;
} P1;
#define Air1	(sizeof(P1) - Offsetof(P1, i) - 1*sizeof(int))

#define Ptime_advance	((P0 *)this)
typedef struct P0 { /* time_advance */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, _3_2_3_i1) - 1*sizeof(uchar))
...
typedef struct State {
	...
	#endif
#endif
	unsigned empty_cal : 1;
	unsigned time_can_advance : 1;
	uchar propagation_delay;
	uchar round_time;
	uchar tau_startup;
	uchar tau_listen;
	uchar tau_coldstart;
...
#define HAS_TRACK	0
/* hidden variable: */	uchar event_pending;
/* hidden variable: */	uchar event_time;
