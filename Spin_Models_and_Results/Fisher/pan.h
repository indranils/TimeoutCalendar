...
#define nstates1	30	/* time_progress */
#define minseq1	96
#define maxseq1	124
#define endstate1	29

#define nstates0	97	/* process */
#define minseq0	0
#define maxseq0	95
#define endstate0	96
...
#define Ptime_progress	((P1 *)this)
typedef struct P1 { /* time_progress */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, min_timeout) - 1*sizeof(uchar))

#define Pprocess	((P0 *)this)
...
#define Air0	(sizeof(P0) - Offsetof(P0, nodeId) - 1*sizeof(uchar))
...
#define HAS_TRACK	0
/* hidden variable: */	uchar in_critical;
